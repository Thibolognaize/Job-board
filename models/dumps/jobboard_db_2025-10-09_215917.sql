...
INSERT INTO public.users (id, first_name, last_name, email, tel, role, is_admin, got_license, password, profile_desc, address, profile_picture_path, cv_path, created_at, sex)
VALUES (7, 'Pierre', 'Bernard', 'pierre.bernard@example.com', '0176592098', 'user', false, true, 'QXlV7rkrDL', 'Expert en bases de données.', '789 Rue de Marseille', '/images/pierre_bernard.jpg', '/cv/pierre_bernard.pdf', '2025-10-16 14:11:03.458955+02', NULL);

INSERT INTO public.users (id, first_name, last_name, email, tel, role, is_admin, got_license, password, profile_desc, address, profile_picture_path, cv_path, created_at, sex)
VALUES (10, 'Thibault', 'Feat', 'thibault.feat@epitech.eu', NULL, 'user', true, true, '$2b$10$oWC4t9rTzDvqg9HYudmiNe6hOK7x91jtjc7PuPyN.wDzqxmAMiJqS', NULL, NULL, NULL, NULL, '2025-10-16 14:12:54.372241+02', NULL);

INSERT INTO public.users (id, first_name, last_name, email, tel, role, is_admin, got_license, password, profile_desc, address, profile_picture_path, cv_path, created_at, sex)
VALUES (6, 'Marie', 'Martin', 'marie.martin@example.com', '0254938663', 'user', false, NULL, 'sF2d5nZWZL', 'Développeuse Frontend passionnée par React.', '456 Rue de Lyon', '/images/marie_martin.jpg', '/cv/marie_martin.pdf', '2025-10-16 14:11:03.458955+02', NULL);

INSERT INTO public.users (id, first_name, last_name, email, tel, role, is_admin, got_license, password, profile_desc, address, profile_picture_path, cv_path, created_at, sex)
VALUES (1, 'Jean', 'Christophe', 'jc@edf.fr', '0923434224', 'company', false, true, '$2b$10$oWC4t9rTzDvqg9HYudmiNe6hOK7x91jtjc7PuPyN.wDzqxmAMiJqS', 'RH', '457 Rue de Lyon', NULL, NULL, '2025-10-17 09:58:31.011334+02', 'male');

INSERT INTO public.users (id, first_name, last_name, email, tel, role, is_admin, got_license, password, profile_desc, address, profile_picture_path, cv_path, created_at, sex)
VALUES (2, 'Jean', 'Dupont', 'jean.dupont@septeo.fr', '+33123456789', 'manager', true, true, '$2a$10$N9qo8uLOickgx2ZMRZoMy.MrXbOvrZz8N5Z8z7vY6JQz5Q7Z8Y9K', 'Responsable technique chez SEPTEO, spécialisé en développement web.', '123 Rue de Paris, 75000 Paris', '/uploads/profiles/jean_dupont.jpg', '/uploads/cvs/jean_dupont_cv.pdf', '2025-10-17 10:14:27.98289+02', NULL);

INSERT INTO public.users (id, first_name, last_name, email, tel, role, is_admin, got_license, password, profile_desc, address, profile_picture_path, cv_path, created_at, sex)
VALUES (3, 'Marie', 'Martin', 'marie.martin@capgemini.com', '+33654321098', 'consultant', false, true, '$2a$10$N9qo8uLOickgx2ZMRZoMy.MrXbOvrZz8N5Z8z7vY6JQz5Q7Z8Y9K', 'Consultante senior en transformation digitale chez Capgemini.', '456 Avenue des Champs-Élysées, 75008 Paris', '/uploads/profiles/marie_martin.jpg', '/uploads/cvs/marie_martin_cv.pdf', '2025-10-17 10:14:27.98289+02', NULL);